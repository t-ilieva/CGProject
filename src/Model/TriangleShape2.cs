...
namespace Draw
{
	...
	[Serializable]
	public class TriangleShape2 : Shape
	{
		#region Constructor

		public TriangleShape2(RectangleF rect) : base(rect)
		{
		}

		public TriangleShape2(RectangleShape rectangle) : base(rectangle)
		{
		}
		...
		public override bool Contains(PointF point)
		{
			...
			PointF a = new PointF((int)Rectangle.X, (int)Rectangle.Y);
		...
		public override void DrawSelf(Graphics grfx)
		{
			...
			Point a = new Point((int)Rectangle.X, (int)Rectangle.Y);
